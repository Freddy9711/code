...
type
  ...
  public
    IFStart: Boolean;
    constructor Create(User, Password, DataBase, Protocol, HostName: AnsiString);
...
constructor TSQLserver.Create(User, Password, DataBase, Protocol, HostName: AnsiString);
begin
