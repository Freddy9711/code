...
begin
  ...
  bmpDeaing.DrawMode := dmTransparent;
  ...
  LoadBitmap32FromPNG(bmpDeaing, 'img/grave.png');
  FPos.X := PosX;
  FPos.Y := PosY;
  FBmp := bmpS;
  FId := Id;
...
procedure TRole.HandleDeaing(Map: TPaintBox32);
var
  posx, posy: Integer;
begin
  posx := FPos.X * CELL_WIDTH + 5;
  posy := FPos.Y * CELL_WIDTH - 5;
  bmpDeaing.DrawTo(Map.Buffer, posx, posy);
end;
